...
public class UIParser
{
			...
			while ((line = in.readLine()) != null)
			{
				...
				try
				{
					...
					else if (word.equals("L"))
					{
						...
						currentControl.appendCode(currentControl.parent.layoutInfo().fullClassName() + ".settings(%1$s)" + line.substring(lineIndex) + ";");
					}
	...
	private void buildSource()
	{
		try
		{
			...
			_code = new StringBuilder("// Generated by GameEditor v").append(GameResources.version()).append(" at ").append(new Date()).append("\r\n\r\n");
			_indent = 0;
